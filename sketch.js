...
spawnFire();
  ...
  restart.visible=false;
   ...
   if (fireGroup.isTouching(zombie)){
    zombie.velocityY=-12;
  }
...
function spawnObstacles() {
   ...
   switch(rand){
     ...
     case 3:  obstacle.addImage(obstacle1);
              ...
              break;
    // case 4:  obstacle.addAnimation(obstacle6);
              break;
   //  case 5:  obstacle.addAnimation(obstacle6);
              break;
    // case 6:  obstacle.addAnimation(obstacle6);
              break;
   }
...
function spawnFire() {
  if (frameCount % 200 === 0){
  var fire = createSprite(600,420,10,40);
  fire.velocityX = -(4+ score/100);
  fire.addImage(obstacle6);
  fire.scale=0.2;
   //generate random obstacles
